...
class AlphabetBScreen extends StatefulWidget {
  @override
  _AlphabetBScreenState createState() => _AlphabetBScreenState();
}

class _AlphabetBScreenState extends State<AlphabetBScreen>
  ...
  Future<void> _loadAudio() async {
    try {
      await _audioPlayer.setAsset('assets/audio/alphabets_b.mp3');
    } catch (e) {
