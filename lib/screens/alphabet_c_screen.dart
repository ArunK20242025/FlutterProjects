...
class AlphabetCScreen extends StatefulWidget {
  @override
  _AlphabetCScreenState createState() => _AlphabetCScreenState();
}

class _AlphabetCScreenState extends State<AlphabetCScreen>
  ...
  Future<void> _loadAudio() async {
    try {
      await _audioPlayer.setAsset('assets/audio/cat.mp3');
    } catch (e) {
