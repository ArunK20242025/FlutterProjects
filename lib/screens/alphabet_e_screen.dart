...
class AlphabetEScreen extends StatefulWidget {
  @override
  _AlphabetEScreenState createState() => _AlphabetEScreenState();
}

class _AlphabetEScreenState extends State<AlphabetEScreen>
  ...
  Future<void> _loadAudio() async {
    try {
      await _audioPlayer.setAsset('assets/audio/elephant.mp3');
    } catch (e) {
