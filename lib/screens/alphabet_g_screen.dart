...
class AlphabetGScreen extends StatefulWidget {
  @override
  _AlphabetGScreenState createState() => _AlphabetGScreenState();
}

class _AlphabetGScreenState extends State<AlphabetGScreen>
  ...
  Future<void> _loadAudio() async {
    try {
      await _audioPlayer.setAsset('assets/audio/giraffe.mp3');
    } catch (e) {
