...
class AlphabetJScreen extends StatefulWidget {
  @override
  _AlphabetJScreenState createState() => _AlphabetJScreenState();
}

class _AlphabetJScreenState extends State<AlphabetJScreen>
  ...
  Future<void> _loadAudio() async {
    try {
      await _audioPlayer.setAsset('assets/audio/jug.mp3');
    } catch (e) {
