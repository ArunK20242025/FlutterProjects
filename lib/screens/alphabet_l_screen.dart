...
class AlphabetLScreen extends StatefulWidget {
  @override
  _AlphabetLScreenState createState() => _AlphabetLScreenState();
}

class _AlphabetLScreenState extends State<AlphabetLScreen>
  ...
  Future<void> _loadAudio() async {
    try {
      await _audioPlayer.setAsset('assets/audio/lion.mp3');
    } catch (e) {
