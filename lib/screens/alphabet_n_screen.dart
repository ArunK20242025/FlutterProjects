...
class AlphabetNScreen extends StatefulWidget {
  @override
  _AlphabetNScreenState createState() => _AlphabetNScreenState();
}

class _AlphabetNScreenState extends State<AlphabetNScreen>
  ...
  Future<void> _loadAudio() async {
    try {
      await _audioPlayer.setAsset('assets/audio/nuts.mp3');
    } catch (e) {
