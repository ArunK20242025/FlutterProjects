...
class AlphabetOScreen extends StatefulWidget {
  @override
  _AlphabetOScreenState createState() => _AlphabetOScreenState();
}

class _AlphabetOScreenState extends State<AlphabetOScreen>
  ...
  Future<void> _loadAudio() async {
    try {
      await _audioPlayer.setAsset('assets/audio/owl.mp3');
    } catch (e) {
