...
class AlphabetPScreen extends StatefulWidget {
  @override
  _AlphabetPScreenState createState() => _AlphabetPScreenState();
}

class _AlphabetPScreenState extends State<AlphabetPScreen>
  ...
  Future<void> _loadAudio() async {
    try {
      await _audioPlayer.setAsset('assets/audio/peacock.mp3');
    } catch (e) {
