...
class AlphabetQScreen extends StatefulWidget {
  @override
  _AlphabetQScreenState createState() => _AlphabetQScreenState();
}

class _AlphabetQScreenState extends State<AlphabetQScreen>
  ...
  Future<void> _loadAudio() async {
    try {
      await _audioPlayer.setAsset('assets/audio/quiet.mp3');
    } catch (e) {
