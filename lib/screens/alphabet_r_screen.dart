...
class AlphabetRScreen extends StatefulWidget {
  @override
  _AlphabetRScreenState createState() => _AlphabetRScreenState();
}

class _AlphabetRScreenState extends State<AlphabetRScreen>
  ...
  Future<void> _loadAudio() async {
    try {
      await _audioPlayer.setAsset('assets/audio/rat.mp3');
    } catch (e) {
