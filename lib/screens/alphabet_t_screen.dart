...
class AlphabetTScreen extends StatefulWidget {
  @override
  _AlphabetTScreenState createState() => _AlphabetTScreenState();
}

class _AlphabetTScreenState extends State<AlphabetTScreen>
  ...
  Future<void> _loadAudio() async {
    try {
      await _audioPlayer.setAsset('assets/audio/tiger.mp3');
    } catch (e) {
