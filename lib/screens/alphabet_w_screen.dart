...
class AlphabetWScreen extends StatefulWidget {
  @override
  _AlphabetWScreenState createState() => _AlphabetWScreenState();
}

class _AlphabetWScreenState extends State<AlphabetWScreen>
  ...
  Future<void> _loadAudio() async {
    try {
      await _audioPlayer.setAsset('assets/audio/watermelon.mp3');
    } catch (e) {
