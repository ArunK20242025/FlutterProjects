...
class AlphabetXScreen extends StatefulWidget {
  @override
  _AlphabetXScreenState createState() => _AlphabetXScreenState();
}

class _AlphabetXScreenState extends State<AlphabetXScreen>
  ...
  Future<void> _loadAudio() async {
    try {
      await _audioPlayer.setAsset('assets/audio/xmax.mp3');
    } catch (e) {
