...
class AlphabetYScreen extends StatefulWidget {
  @override
  _AlphabetYScreenState createState() => _AlphabetYScreenState();
}

class _AlphabetYScreenState extends State<AlphabetYScreen>
  ...
  Future<void> _loadAudio() async {
    try {
      await _audioPlayer.setAsset('assets/audio/yak.mp3');
    } catch (e) {
