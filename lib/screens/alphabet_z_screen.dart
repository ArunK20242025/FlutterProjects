...
class AlphabetZScreen extends StatefulWidget {
  @override
  _AlphabetZScreenState createState() => _AlphabetZScreenState();
}

class _AlphabetZScreenState extends State<AlphabetZScreen>
  ...
  Future<void> _loadAudio() async {
    try {
      await _audioPlayer.setAsset('assets/audio/zebra.mp3');
    } catch (e) {
        ...
        body: Stack(
          children: [
            ...
            Positioned(
              ...
              child: GestureDetector(
                onTap: () {
                  Navigator.pushNamed(context, '/congs');
                },
                child: Image.asset(
