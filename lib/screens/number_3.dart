...
class NumberThreeScreen extends StatefulWidget {
  @override
  _NumberThreeScreenState createState() => _NumberThreeScreenState();
}

class _NumberThreeScreenState extends State<NumberThreeScreen>
  ...
  Future<void> _loadAudio() async {
    try {
      await _audioPlayer.setAsset('assets/audio/number_Three.mp3');
    } catch (e) {
